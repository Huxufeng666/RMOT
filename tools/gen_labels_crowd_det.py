...
if __name__ == '__main__':
    data_val = '/RMOT/dataset/data/crowdhuman/Images/val'
    label_val = '/RMOT/dataset/data/crowdhuman/labels_with_ids/val'
    ann_val = '/RMOT/dataset/data/crowdhuman/annotation_val.odgt'
